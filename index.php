 ...
 <div id="page-wrapper" class="">
        ...
        <div class="container-fluid">
			...
			<div class="row " style="margin-top:-20px">
				...
				<form name="userForm" ng-submit="submitForm(userForm.$invalid)" >
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-md-12">
                                <input name="producer_name" id="producer_name" placeholder="Name" class="form-control1" type="text" ng-model="user.producer_name" required ng-minlength="3" ng-maxlength="8">
                                 <div class="help-block" ng-messages="userForm.producer_name.$error" ng-if="userForm.producer_name.$touched && userForm.producer_name.$invalid" >
					...
					<!--	<div class="form-group">
                            ...
                            <div class="col-md-12">
								...
								ng-show="userForm.producer_name.$touched && userForm.producer_name.$invalid"
					...
					<!--     <option value="<?php //echo $continents['continent_id'];?>"><?php //echo $continents['continent_name'];?></option>-->
						...
						<div class="form-group required">
                            ...
                            <div class="col-md-12">
                                <input name="address1" id="address1" placeholder="Address1" class="form-control1" type="text" ng-model="user.address1">
                                 <div class="help-block" ng-messages="userForm.address1.$error" ng-if="userForm.address1.$touched && userForm.address1.$invalid" >
									<p ng-message="required">Your Field is required.</p>
									</div>
                            </div>
                        </div>
						<div class="form-group required">
                            ...
                            <div class="col-md-12">
                                <input name="address2" id="address2" placeholder="Address2" class="form-control1" type="text" ng-model="user.address2" ng-keypress="userForm.$submitted=false">
                                 <div class="help-block" ng-messages="userForm.address2.$error" ng-if="userForm.address2.$touched && userForm.address2.$invalid && userForm.address2.$dirty  && userForm.$submitted" >
									<p ng-message="required">Your Field is required.</p>
									</div>
								</div>
                        </div>
						<div class="form-group required">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="help-block" ng-messages="userForm.address3.$error" ng-if="userForm.address3.$touched && userForm.address3.$invalid" >
									<p ng-message="required">Your Field is required.</p>
									</div>
                            </div>
                        </div>
						<div class="form-group required">
                            ...
                            <div class="col-md-12">
                               ...
                               <div class="help-block" ng-messages="userForm.pin_id.$error" ng-if="userForm.pin_id.$touched && userForm.pin_id.$invalid" >
									<p ng-message="required">Your Field is required.</p>
									</div>
                            </div>
                        </div>
                        <div class="form-group required">
                            ...
                            <div class="col-md-12">
                                <input name="contact_email" id="contact_email" placeholder="Enter Email Id" class="form-control1" type="email" ng-model="user.contact_email">
                                <div class="help-block" ng-messages="userForm.contact_email.$error" ng-if="userForm.contact_email.$touched && userForm.contact_email.$invalid" >
									<p ng-message="required">Your Field is required.</p>
									</div>
                            </div>
                        </div>
						<div class="form-group required">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="help-block" ng-messages="userForm.password.$error" ng-if="userForm.password.$touched && userForm.password.$invalid" >
									<p ng-message="required">Your Field is required.</p>
									</div>
                            </div>
                        </div>
						<div class="form-group required">
                            ...
                            <div class="col-md-12">
                                <input name="confirm_password" id="confirm_password" placeholder="Enter Confirm Password" class="form-control1" type="password" ng-model="user.confirm_password">
                                 <div class="help-block" ng-messages="userForm.confirm_password.$error" ng-if="userForm.confirm_password.$touched && userForm.confirm_password.$invalid" >
									<p ng-message="required">Your Field is required.</p>
									</div>
                            </div>
                        </div>
						<div class="form-group required">
                            ...
                            <div class="col-md-12">
                                <input name="personal_email" id="personal_email" placeholder="Alternate Email Id" class="form-control1" type="email" ng-model="user.personal_email">
                                <div class="help-block" ng-messages="userForm.personal_email.$error" ng-if="userForm.personal_email.$touched && userForm.personal_email.$invalid" >
									<p ng-message="required">Your Field is required.</p>
									</div>
                            </div>
                        </div>
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-md-12">
                                <input name="contact_no1" id="contact_no1" placeholder="Contact Number" class="form-control1" type="number" ng-model="user.contact_no1">
                                <div class="help-block" ng-messages="userForm.contact_no1.$error" ng-if="userForm.contact_no1.$touched && userForm.contact_no1.$invalid" >
									<p ng-message="required">Your Field is required.</p>
									</div>
                            </div>
                        </div>
